...
function ImageModal({ image, isOpen, onClose, ...rest }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-backdrop-color bg-opacity-80 flex items-center justify-center">
          ...
          <img
            ...
            className={`${
              isZoomed
                ...
                : "sm:max-w-[100vw] max-h-[80vh] object-cover cursor-zoom-in"
            }`}
            {...rest}
